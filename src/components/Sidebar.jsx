...
const NavLinks = ({handleClick}) => (
  <div className="mt-10">
    {links.map((item) => (
      ...
      key={item.name}
      to= {item.to}
      className="flex flex-row justify-start items-center my-6
...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="md:flex hidden flex-col w-[200px] py-10 px-4 bg-[#191624]">
      <img src={logo} alt="" className="w-full h-144 object-contain" />
      <NavLinks></NavLinks>
    </div>
    ...
    backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${mobileMenuOpen?"left-0":"hidden"}`}>
